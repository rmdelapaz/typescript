...
```
[INSERT PROJECT PATH HERE - e.g., \\wsl$\Ubuntu\home\username\projects\projectname]
```
...
**Project Type:** [e.g., React TypeScript Course, Web Development Tutorial, etc.]

**Working Directory:** [INSERT FULL PATH]

**Reference Template/Materials:** [INSERT PATH TO TEMPLATES OR REFERENCE FILES]
...
**Progress:** [e.g., Module X of Y complete, 70% done, etc.]
...
[Add any special instructions, gotchas, or important context here]
